...
public class MeetingAddActivity extends BaseActivity {
    ...
    protected void init() {
        ...
        meetingId = getIntent().getLongExtra("meeting_id",0);
        MeetingEntity meetingEntity = App.getDaoInstant().getMeetingEntityDao().load(meetingId);
        ...
        ll_add.setOnClickListener(v -> {
            ...
            if (meetingEntity == null)
            {
                ...
                if (meetingEntity.getContacts() == null)meetingEntity.setContacts(new ArrayList<>());
                ...
                for (ContactsEntity e:adapter.getSl()) {
                    for (ContactsEntity e2:meetingEntity.getContacts()) {
