...
import hzhl.net.hlcall.adapter.TongHuaAdapter;
...
public class CallRecordAllFg extends BaseFragment implements TongHuaAdapter.OnRecyclerViewItemClickListener {
    @Bind(R.id.recy_all_tonghua)
    ...
    protected int getLayoutResID() {
        return R.layout.fg_callrecord_all;
    }

    @Override
    protected void initView() {
        EventBus.getDefault().register(this);
        adapter = new TongHuaAdapter(getmContext(), dataList);
        ...
        switch (view.getId()) {
            case R.id.tv_del:
                ...
                if (onAfterDelListener != null) {
                    onAfterDelListener.onCallRecordAllAfterDel();
                }
                break;
