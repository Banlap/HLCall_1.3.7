...
public class TongHuaMissCallAdapter extends RecyclerView.Adapter<TongHuaMissCallAdapter.ViewHolder> {
    ...
    public interface OnRecyclerViewItemClickListener {
        void OnItemClick(TongHuaEntity entity, int position);
    ...
    public TongHuaMissCallAdapter(Context context, List<TongHuaEntity> list) {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
         ...
         * 通话类型
         */
        if ("未接".equals((entity.getType()))) { //"未接"
