...
public class AutoAdjustHelper {
	...
	public void init(Context context, AttributeSet attrs) {
		if (attrs != null) {
			TypedArray types = context.obtainStyledAttributes(attrs, R.styleable.AutoAdjustView);
			mAutoAdjustTypeStr = types.getString(R.styleable.AutoAdjustView_adjustType);
